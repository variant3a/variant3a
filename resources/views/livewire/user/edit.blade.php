                    ...
                    <div class="card-body">
                        ...
                        <div class="card-text text-end">
                            ...
                            <div class="form-floating mb-3">
                                <input wire:model="user.job" type="text" class="form-control border-700 text-bg-700 @error('user.job') is-invalid @enderror" placeholder="Engineer" autocomplete="job">
                            ...
                            <div class="form-floating mb-3">
                                <input wire:model="user.state" type="text" class="form-control border-700 text-bg-700 @error('user.state') is-invalid @enderror" placeholder="Tokyo, Japan" autocomplete="state">
                                <label for="floatingInput">
                                    State
                                </label>
                                @error('user.state')
                            ...
                            <div class="form-floating mb-3">
                                <textarea wire:model="user.bio" type="text" class="form-control border-700 text-bg-700 @error('user.bio') is-invalid @enderror" placeholder="hello" autocomplete="bio" style="height:10rem"></textarea>
                                <label for="floatingInput">
                                    bio
                                </label>
                                @error('user.bio')
            ...
            <div class="col-md-8 mb-3">
                <div class="card text-bg-800">
                    <div class="card-body">
                        ...
                        <div class="form-floating mb-3">
                            <input wire:model="user.programming_lang" type="text" class="form-control border-700 text-bg-700 @error('user.programming_lang') is-invalid @enderror" placeholder="JavaScript" autocomplete="programming_lang">
                            <label for="floatingInput">
                        ...
                        <div class="form-floating mb-3">
                            <input wire:model="user.frameworks" type="text" class="form-control border-700 text-bg-700 @error('user.frameworks') is-invalid @enderror" placeholder="Laravel" autocomplete="frameworks">
                            <label for="floatingInput">
                                Frameworks
                            </label>
